...
#+begin_example
Usage:
  bin/tooloo -V|--version[=Any] [--verbose[=Any]]
  bin/tooloo add <path> -- Add & updates documentation of a command with a .toml file, or an ansiicast demo with a .cast file
  bin/tooloo demo <command_name> -- play the asciicast demo of the specified command
  bin/tooloo demos -- List all your commands that have associated asciicast demos
  bin/tooloo find [<search_strings> ...] -- Execute a full text against documented commands. Search terms should be separate arguments.
  bin/tooloo ingest-many <directory_path>
  bin/tooloo list -- List all your commands & their quick description
  bin/tooloo list <filter> -- Lists a filtered subset of commands via filter: 'demos'
  bin/tooloo export <format> <directory> -- Create a static blog documenting all your commands
  bin/tooloo remove <command_name> -- Remove a command from the database
  bin/tooloo show <command_name> -- Display the full details of a specific command
  bin/tooloo template <destination> -- Generate a blank TOML template at the specified location.
  bin/tooloo update <path> -- Updates documentation of a command with a .toml file, or an ansiicast demo with a .cast file
...
#+begin_src
tooloo ingest-many /path/to/dir/with/toml/files
#+end_src
...
You can either =tooloo add path/to/cast_file= or rerun =ingest-many= again.
